...
export default async function NotificationsPage({
  ...
  return (
    <div className="space-y-6">
      ...
      <EmailSettingsCard
        emailNewListingsEnabled={emailSettings.email_new_listings_enabled === true}
      />
